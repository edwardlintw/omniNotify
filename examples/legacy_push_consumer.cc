// This application implements a push consumer which uses the old-style
...
#define CLIENT_IMPL_CLASS  LegacyPushConsumer_i
#define CLIENT_CLASS_VAR   CosEvC::PushConsumer_var
#define CLIENT_NAME        "legacy_push_consumer"
